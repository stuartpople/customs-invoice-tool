...
_SYSTEM_PROMPT = (
    ...
    "This is a customs classification code found in a 'Commodity Code', 'HS Code', 'HS export code', "
    "'HS import code', or 'Tariff Code' label/column. "
    "It is typically 8-10 digits and starts with a valid HS chapter (01-97 or 99). "
    "It is NOT a price, monetary value, part number, stock code, order number, or shipment number. "
    "CRITICAL: On RS Components/SITPRO invoices the HS code appears on its own line labelled "
    "'HS export code XXXXXXXX' — use the digits after that label, NOT the unit price or total amount. "
    "If no genuine HS/tariff code label is visible, use null — do not substitute a price or part number. "
